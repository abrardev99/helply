...
export default function AgentOriginsField({
    defaultOrigins = [],
    errors,
}: Props) {
    ...
    return (
        <div className="grid gap-2">
            ...
            <p className="text-sm text-muted-foreground">
                Websites that may embed this agent's chat widget, e.g.{' '}
